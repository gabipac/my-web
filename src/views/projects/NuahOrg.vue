<template>
    <project-card
        ...
        <div class="ml-md-10 ml-lg-10">
            ...
            <p class="mb-3"><strong>Release: </strong>2019</p>
            ...
            <p class="mb-3"><strong>Website: </strong>nuah.org</p>
            <div class="my-tasks">
    ...
    export default {
        ...
        data: () => ({
            ...
            layouts: [
                {
                    title: 'Header',
                    img: require('@/assets/imgs/nuah-header.jpg'),
                },
                {
                    title: 'Custom UI',
                    img: require('@/assets/imgs/nuah-objects.jpg'),
                },
                {
                    title: 'Custom UI',
                    img: require('@/assets/imgs/nuah-objects2.jpg'),
                },
                {
                    title: 'Custom UI',
                    img: require('@/assets/imgs/nuah-typewriter.jpg'),
                },
                {
                    title: 'Custom UX',
                    img: require('@/assets/imgs/nuah-img-link.jpg'),
                },
                {
                    title: 'Custom UX',
                    img: require('@/assets/imgs/nuah-links.jpg'),
                },
                {
                    title: 'Design mock up',
                    img: require('@/assets/imgs/nuah-design.jpg'),
                },
                {
                    title: 'Design mock up',
                    img: require('@/assets/imgs/nuah-design1.jpg'),
                },
                {
                    title: 'Design mock up',
                    img: require('@/assets/imgs/nuah-projects.jpg'),
                },
            ],
        }),
        methods: {
