...
rsync -a -v -z --exclude 'node_modules' --exclude '.gitignore' --exclude '.git' --exclude '.idea' --exclude '.DS_Store' '/Users/gabipac/Proyect/TUTORIALS/my-app/' --rsh='ssh -p21098' cioclrha@66.29.141.35:/home/cioclrha/imaginegabi
